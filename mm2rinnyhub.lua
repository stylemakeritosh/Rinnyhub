print([[
Rinny Hub - https://discord.gg/B2yjSzGFW8
]])
...
do
    ...
    WindUI:Popup(
        {
            Title = gradient("Rinny Hub Loaded! - Murder Mystery 2", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Icon = "rbxassetid://1",
            Content = gradient("+ Version: 1", Color3.fromHex("#ffffff"), Color3.fromHex("#ffffff")) ..
                gradient(" [RINNY HUB OFFICIAL]", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Buttons = {
    ...
    WindUI:Notify(
        {
            Title = gradient("Rinny Hub", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
    ...
    local Window =
        WindUI:CreateWindow(
        {
            Title = gradient("Rinny Hub - Murder Mystery 2", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Icon = "rbxassetid://1",
            Author = gradient("Version: 1 | rintoshiii", Color3.fromHex("#ffffff"), Color3.fromHex("#ffffff")),
            Folder = "RINNYHUB_MM2",
    ...
    local function teleportToPlayer()
        if (teleportTarget and teleportTarget.Character) then
            ...
            WindUI:Notify(
                {Title = "Rinny Hub", Content = "Target not found or unavailable", Icon = "x-circle", Duration = 3}
            )
        end
    end
...
Tabs.MainTab:Button({
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("Rinny Hub .GG/RINNYHUB", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Desc = "My Main Social",
            Image = "star",
            Color = "Red",
            Buttons = {
                {
                    Icon = "circle",
                    Title = "Rinny Hub DISCORD",
                    Callback = function()
                        if pcall(setclipboard, "https://discord.gg/B2yjSzGFW8") then
                            WindUI:Notify(
                                {
                                    Title = "Copied!",
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("Rinny Hub GUNS.LOL", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Desc = "My Another Social",
            Image = "star",
            Color = "Red",
            Buttons = {
                {
                    Title = "Rinny Hub SOCIAL",
                    Icon = "circle",
                    Callback = function()
                        if pcall(setclipboard, "https://discord.gg/B2yjSzGFW8") then
                            WindUI:Notify(
